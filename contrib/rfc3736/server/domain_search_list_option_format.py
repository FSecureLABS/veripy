...
class DomainSearchListOptionFormatTestCase(DHCPv6Helper):
    """
    Domain Search List Option Format
    
    Verify that a server correctly formats a Domain Search List Option.
    
    @private
    Source:         IPv6 Ready DHCPv6 Interoperability Test Suite (Section 8.1.8)
    """
