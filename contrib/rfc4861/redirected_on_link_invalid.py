...
class ICMPCodeIsNot0TestCase(RedirectionHelper):
    ...
    def set_up(self):
        self.p = IPv6(src=str(self.router(1).link_local_ip(iface=1)), dst=str(self.target(1).link_local_ip()), hlim=255)/\
                    ICMPv6ND_Redirect(code=1, dst=str(self.node(2).global_ip()), tgt=str(self.node(2).global_ip()))
...
class ICMPChecksumInvalid(RedirectionHelper):
    ...
    def set_up(self):
        self.p = IPv6(src=str(self.router(1).link_local_ip(iface=1)), dst=str(self.target(1).link_local_ip()), hlim=255)/\
                    ICMPv6ND_Redirect(cksum=0, dst=str(self.node(2).global_ip()), tgt=str(self.node(2).global_ip()))
...
class ICMPDestinationIsMulticastTestCase(RedirectionHelper):
    ...
    def set_up(self):
        self.p = IPv6(src=str(self.router(1).link_local_ip(iface=1)), dst=str(self.target(1).link_local_ip()), hlim=255)/\
                    ICMPv6ND_Redirect(dst="ff02::1", tgt=str(self.node(2).global_ip()))
